...
use common::*;
use crate::{ AggregatedBook, Level};
...
fn get_top_asks_aggregate_book_test() {
    ...
    asks_from_exchange_1.insert(Decimal::from_str("10.0").unwrap(), Decimal::from_str("5").unwrap());
    asks_from_exchange_1.insert(Decimal::from_str("9.0").unwrap(), Decimal::from_str("5").unwrap());
    asks_from_exchange_1.insert(Decimal::from_str("8.0").unwrap(), Decimal::from_str("5").unwrap());

    asks_from_exchange_2.insert(Decimal::from_str("11.0").unwrap(), Decimal::from_str("5").unwrap());
    asks_from_exchange_2.insert(Decimal::from_str("8.0").unwrap(), Decimal::from_str("5").unwrap());
    asks_from_exchange_2.insert(Decimal::from_str("7.0").unwrap(), Decimal::from_str("5").unwrap());

    let expected1 = SnapshotData {
    ...
    agrregate_book_result.update_book(expected2); 
    ...
    asks_expected.push(Level::new(binance.clone(),  Decimal::from_str("9.0").unwrap(), Decimal::from_str("5").unwrap()));
    asks_expected.push(Level::new(binance.clone(),  Decimal::from_str("8.0").unwrap(), Decimal::from_str("5").unwrap()));
    asks_expected.push(Level::new(bitstamp.clone(), Decimal::from_str("8.0").unwrap(), Decimal::from_str("5").unwrap()));
    asks_expected.push(Level::new(bitstamp.clone(), Decimal::from_str("7.0").unwrap(), Decimal::from_str("5").unwrap()));
...
fn  get_top_bids_aggregate_book_test() {
    ...
    let mut agrregate_book_result = AggregatedBook::new();
    agrregate_book_result.update_book(expected1);
    agrregate_book_result.update_book(expected2); 
